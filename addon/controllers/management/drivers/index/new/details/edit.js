import OperationsDriversIndexNewDetailsDriverController from './new';
import { tracked } from '@glimmer/tracking';
import { action } from '@ember/object';

export default class OperationsDriversIndexEditController extends OperationsDriversIndexNewDetailsDriverController {
  /**
      ...
      return driver
        ...
        .then((driver) => {
          return this.transitionToRoute('management.drivers.index').then(() => {
            this.notifications.success(`Driver '${driver.service_name}' updated`);
            this.resetForm();
          });
        })
